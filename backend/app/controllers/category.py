...
class CategoryController(Controller):
    ...
    async def create_category(
        self, data: DTOData[Category], categories_repo: CategoryRepository
    ) -> Category:
    ...
    async def update_category(
        self, id: int, data: DTOData[Category], categories_repo: CategoryRepository
    ) -> Category:
        """Update a category by ID."""
        raw_obj = data.as_builtins()
        obj = categories_repo.update(Category(id=id, **raw_obj))
        return obj
